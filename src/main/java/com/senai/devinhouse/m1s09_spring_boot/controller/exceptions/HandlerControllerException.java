...
public class HandlerControllerException {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ExceptionHandler(AccountOperationNotValidException.class)
    public ResponseEntity<StandardError> accountNotFound(AccountOperationNotValidException e, HttpServletRequest request){
        StandardError error = new StandardError();
        error.setClassMethod(e.getClass().descriptorString());
